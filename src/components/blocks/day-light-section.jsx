...
const DayLightSection = () => {
    ...
    const sectionTop = useFadeIn({ direction: 'top', threshold: 0.3, duration: 700, delay: 300 })
    const buttonPopUp1 = usePopUp({ threshold: 0.2, duration: 600, delay: 300 })
    const buttonPopUp2 = usePopUp({ threshold: 0.2, duration: 600, delay: 450 })
        ...
        <div ref={sectionFade.ref} style={sectionFade.animationStyles} className='relative w-full h-screen overflow-hidden'>
            ...
            <Card className='relative overflow-hidden h-full rounded-none' >
                ...
                <CardContent className="h-full flex flex-col items-center justify-center px-20 w-4/5 mx-auto z-2 max-sm:px-5 max-sm:w-full">
                   ...
                   <div ref={sectionTop.ref} style={sectionTop.animationStyles}> <h2  className="fade-out-top text-8xl text-white font-semibold mb-3 text-center max-sm:text-2xl md:text-8xl" >Making life effortlessly easy!</h2></div>
                    <TypingText 
                        text={["Walk into a low-lit, warm and cosy room to help you unwind before bed or have your home light up as the sun sets.", "Walk into a low-lit, warm and cosy room to help you unwind before bed or have your home light up as the sun sets."]}
                        as="p"
                        typingSpeed={30}
                        initialDelay={500}
                        loop={true}
