...
const DisplayCards = () => {
    ...
    return (
        <div className='flex flex-col gap-10 my-20'>
            <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-center'>Choose Your Smart Home Setup</h1>
            <div className='container mx-auto flex items-center gap-5 max-sm:flex-col max-xl:px-5 max-sm:mb-10'>
