                ...
                {Array.from({ length: 8 }).map((_, index) => (
                    <CarouselItem key={index} className="pl-5 md:basis-1/2 lg:basis-1/5 max-sm:pl-0 max-sm:basis-1/2">
                        <div className="p-1 max-sm:p-2">
                            <Card className='bg-secondary flex flex-col pt-10 gap-20 justify-between items-center group overflow-hidden max-sm:gap-5 dark:bg-card max-sm:pt-5 cursor-pointer'>
                                <div>
