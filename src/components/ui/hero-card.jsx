...
const HeroCard = ({ item = {} }) => {
    return (
        <Card className='w-full relative overflow-hidden group z-2' >
            ...
            <CardContent className=" h-[350px] px-10 py-5 flex justify-between items-center max-sm:h-[40vh] max-sm:px-5 max-sm:py-3 max-sm:flex-col max-sm:gap-0 select-none max-sm:justify-start">
                <div className="">
