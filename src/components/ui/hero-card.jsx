...
const HeroCard = ({ item = {} }) => {
    return (
        <Card className='w-full relative overflow-hidden group z-2' >
            ...
            <CardContent className=" h-[350px] px-10 py-5 flex flex-col justify-center max-sm:h-[22vh]">
                <div className="w-1/2 z-2">
                    ...
                    <p className="text-md text-muted-foreground capitalize mb-6 max-sm:text-xs max-sm:mb-1">{item.subTitle ?? ''}</p>
