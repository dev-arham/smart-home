  ...
  return (
    <Card
      ...
      <div className='w-3/4 flex flex-col items-center z-2'>
        <h6 className='text-white font-bold text-sm text-center uppercase mb-2'>{badge}</h6>
        <h4 className='text-white font-bold text-4xl text-center capitalize mb-5'>{title}</h4>
