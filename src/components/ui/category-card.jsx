...
const CategoryCard = ({image, badge, title}) => {
  return (
    <Card
      className='w-full h-[75vh] bg-secondary flex flex-col pt-15 gap-20 justify-between items-center group relative overflow-hidden z-2 max-sm:h-[60vh] cursor-pointer'>
      ...
      <div className='w-3/4 flex flex-col items-center z-2 max-sm:w-full max-sm:px-5'>
        ...
        <h4 className='text-white font-bold text-4xl text-center capitalize mb-5 max-sm:text-2xl'>{title}</h4>
